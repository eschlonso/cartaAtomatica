                ...
                <td><table width="550" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="548"><table width="548" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><script type="text/javascript">AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0','width','548','height','111','src','images/tit_servicios_gratis','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','images/tit_servicios_gratis','menu','false' ); //end AC code</script>
                          <noscript>
                          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"   codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="548" height="111">
                            <param name="movie" value="images/tit_servicios_gratis.swf" />
                            <param name="menu" value="false" />
                            <param name="quality" value="high" />
                            <embed src="images/tit_servicios_gratis.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="548" height="111"></embed>
                          </object>
                          </noscript></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td height="19" align="center"><img src="images/servicio-gratis.jpg" width="521" height="250"><br></td>
                      </tr>
                      <tr>
                        <td height="20" align="center" valign="bottom"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="left" class="gris2"><p>                              Promoci&oacute;n v&aacute;lida desde el 01/02/10 hasta el 28/02/10. Todos los socios que hayan financiado sus servicios o impuestos con Carta Autom&aacute;tica participan del sorteo por la bonificaci&oacute;n del impuesto o servicio financiado hasta $50. El importe se acreditar&aacute; en el resumen de cuenta de los ganadores en el mes marzo 2010. Se sortear&aacute;n 100 ganadores. El sorteo se realizar&aacute; el 11/3/10 ante Escribano P&uacute;blico en Sarmiento 767 PB, Ciudad Aut&oacute;noma de Buenos Aires. Ver Bases y Condiciones en www.cartaautomatica.com.ar y en las Sucursales de Carta Autom&aacute;tica del pa&iacute;s.</p>
                              <p></p></td>
                          </tr>
                        </table></td>
                      </tr>
