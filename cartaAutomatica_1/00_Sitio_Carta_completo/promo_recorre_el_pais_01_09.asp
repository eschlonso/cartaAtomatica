                    ...
                    <td width="548"><table width="548" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="548" height="111">
                          <param name="movie" value="images/tit_estaciones_de_servicio.swf">
                          <param name="quality" value="high">
                          <param name="wmode" value="opaque">
                          <embed src="images/tit_estaciones_de_servicio.swf" quality="high" wmode="opaque" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="548" height="111"></embed>
                        </object></td>
                      </tr>
                      <tr>
                        <td align="center"><img src="images/promo_recorre_el_pais_01_09.jpg" width="493" height="541"></td>
                      </tr>
                      <tr>
                        <td height="30" align="center" class="negroch">&nbsp;</td>
                      </tr>
