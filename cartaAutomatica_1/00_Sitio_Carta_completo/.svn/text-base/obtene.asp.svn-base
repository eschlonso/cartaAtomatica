...
'		on error resume next
		...
		if Not objMail.EOF then
			...
			objMessage.From = strMail 
			objMessage.To = objMail(0) 
			strBody = "Se ha recibido una solicitud de tarjeta con los siguientes datos: <br>Nombre: " &strNombre & "<br>Apellido: " & strApellido &_
					 "<br>Localidad: " & strLocalidad & "<br>Teléfono: " &strTelefono & "<br>Móvil: " & strMovil & "<br>Horario de contacto: " & strHorario & "<br>DNI: " & strDNI
...
%>
                        ...
                        <td><table width="530" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td width="548"><table width="93%"  border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="5%"><em></em></td>
                                  <td colspan="2"><em class="titulos"><strong>Requisitos</strong></em></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <td width="90%" class="negro"><span class="texto"><strong>-Responsable Inscripto: </strong> Inscripci&oacute;n en la AFIP, declaraci&oacute;n jurada de ganancias, &uacute;ltimo pago de impuesto a las ganancias, &uacute;ltimo pago de IVA, inscripci&oacute;n y &uacute;ltimo pago de ingresos brutos. <br>
                                      <strong>-Monotributista: </strong> Inscripci&oacute;n (formulario 162) y &uacute;ltimo pago de monotributo, inscripci&oacute;n y &uacute;ltimo pago de ingresos brutos. <br>
  ...
  <tr>
    ...
    <td height="9" class="blanco"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="4%" height="10"><span class="estilo"><a href="http://www.quick-media.com" target="_blank" class="blanco">Qm</a></span></td>
        ...
        <td width="51%" align="right" class="blanco-1">- <a href="sitemap.asp" class="blanco">Mapa del Sitio</a> <span class="blanco1">- Todos los derechos reservados &copy; Carta Autom&aacute;tica 2006</span></td>
      </tr>
    </table></td>
    <td height="9">&nbsp;</td>
  </tr>
