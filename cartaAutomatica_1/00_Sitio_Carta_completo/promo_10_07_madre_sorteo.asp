                    ...
                    <td width="548"><table width="548" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="548" height="111">
                          <param name="movie" value="images/promo_mes_mama/tit_mama_sorteo.swf">
                          <param name="quality" value="high">
                          <embed src="images/promo_mes_mama/tit_mama_sorteo.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="548" height="111"></embed>
                        </object></td>
                      </tr>
                      <tr>
                        <td align="center"><table width="93%" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td align="center"><img src="images/promo_mes_mama/promo_mama_sorteo.jpg" width="348" height="626"><br>
                              <br></td>
                          </tr>
                          <tr>
                            <td align="left"><a href="#" class="celeste" onClick="MM_openBrWindow('pop_legales_dia_madre.html','','scrollbars=yes,width=530,height=430')">&gt;&gt; T&eacute;rminos y Condiciones</a></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
