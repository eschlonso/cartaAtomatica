...
<table width="200" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <td valign="top"><table width="549" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td width="547" valign="top"><table width="547" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td colspan="2" align="center"><img src="images/etica.jpg" border="0" usemap="#Map2" style="display:block; border:none; padding:0;"></td>
                          </tr>
                        </table></td>
                        <td width="1" height="1"></td>
                      </tr>
  ...
  <map name="Map">
    <area shape="rect" coords="333,741,547,774" href="http://www.cartaautomatica.com.ar/docs/masterconsultas.pdf" target="_blank">
  </map>

  <map name="Map2">
    <area shape="rect" coords="160,1359,400,1374" href="https://www.eticagruposupervielle.kpmg.com.ar/" target="_blank" alt="Etica Supervielle">
  </map>
</body>
</html>