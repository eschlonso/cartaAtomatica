...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','548','height','111','src','images/tit_dia_padre','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','images/tit_dia_padre' ); //end AC code
                      ...
                      <tr>
                        <td align="center" valign="top"><img src="images/promo_dia_padre_08_06.jpg" width="502" height="687"></td>
                      </tr>
                      <tr>
                        <td height="60" align="center" class="negroch"><table width="94%" cellspacing="0" cellpadding="0">
                            <tr>
                              <td height="14" align="left"><a href="#" class="celeste" onClick="MM_openBrWindow('pop_legales_promo_dia_padre.html','','scrollbars=yes,width=530,height=430')">&gt;&gt; Bases y Condiciones</a></td>
                            </tr>
                          </table></td>
                      </tr>
