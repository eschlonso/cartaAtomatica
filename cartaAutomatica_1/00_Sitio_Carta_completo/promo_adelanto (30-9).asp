                  ...
                  <tr>
                    <td width="1" height="1" bgcolor="#B6B7B8"></td>
                      <td width="547" valign="top"><table width="547" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td height="1" colspan="2" align="center" bgcolor="#B6B7B8"></td>
                        </tr>
                        <tr>
                          <td colspan="2" align="center"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="548" height="111">
                            <param name="movie" value="images/tit_promo_adelantos.swf">
                            <param name="quality" value="high">
                            <param name="wmode" value="opaque">
                            <embed src="images/tit_promo_adelantos.swf" quality="high" wmode="opaque" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="548" height="111"></embed>
                          </object></td>
                        </tr>
                         <tr>
                         ...
                         <tr>
                           <td height="30" colspan="2" align="center" class="txt_negro">
                           <img src="images/interna_servicios.jpg" width="522" height="228" />
                         </td>
                         </tr>
                         
                         <tr>
                            
                            <td class="gris" colspan="2" align="center"><br /><br />Promoción válida desde el 01/09/2010 hasta el 30/09/2010. Todos los socios que soliciten un adelanto en efectivo participan del sorteo por la bonificación del adelanto. Tope máximo de devolución $300.- El importe se acreditará en el resumen de cuenta de los ganadores del mes de Octubre 2010. Se sortearán 20 ganadores, uno por cada sucursal de Carta Automática. El sorteo se realizará el 13/10/2010 ante Escribano Público en Sarmiento 767 PB, Ciudad Autónoma de Buenos Aires. Ver Bases y Condiciones en www.cartaautomatica.com.ar y en las Sucursales de Carta Automática del país.<br /></td>
                          </tr>
                         
                         
                         <tr>
                         <td colspan="2" align="center" class="txt_negro"><br />
                           Retir&aacute; un adelanto en efectivo en todos los cajeros de la red Banelco del pa&iacute;s o en nuestra sucursal y particip&aacute; del sorteo de una bonificaci&oacute;n de $300.<br /><br />Solicita tu clave en la sucursal o llamanos al 0810-999-9988. </td>
                         </tr>
                         <tr>
