                ...
                <td><table width="550" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="548"><table width="93%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><script type="text/javascript">AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0','width','548','height','111','src','images/tit_golpe_suerte_raspa','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','images/tit_golpe_suerte_raspa','menu','false' ); //end AC code</script>
                          <noscript>
                          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"   codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="548" height="111">
                            <param name="movie" value="images/tit_golpe_suerte_raspa.swf" />
                            <param name="menu" value="false" />
                            <param name="quality" value="high" />
                            <embed src="images/tit_golpe_suerte_raspa.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="548" height="111"></embed>
                          </object>
                          </noscript></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td height="19" align="center"><img src="images/golpe_suerte_raspadita.jpg" alt="golpe de suerte" width="431" height="641"></td>
                      </tr>
                      <tr>
                        <td align="center"><a href="#" class="celeste" onClick="MM_openBrWindow('pop_legales_golpe_suerte_raspa.html','','scrollbars=yes,width=530,height=430')"></a></td>
                      </tr>
                      <tr>
                        <td height="19" align="center"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td align="left"><a href="#" class="celeste" onClick="MM_openBrWindow('pop_legales_golpe_suerte_raspa.html','','scrollbars=yes,width=530,height=430')">&gt;&gt; T&eacute;rminos y Condiciones</a></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td width="548" height="19" align="center">&nbsp;</td>
                      </tr>
                    </table></td>
                    <td width="1" height="1" bgcolor="#B6B7B8"></td>
                  </tr>
