                ...
                <td><table width="550" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="548"><table width="548" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><script type="text/javascript">AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0','width','548','height','111','src','images/tit_extravio','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','images/tit_extravio','menu','false' ); //end AC code</script>
                          <noscript>
                          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"   codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="548" height="111">
                            <param name="movie" value="images/tit_extravio.swf" />
                            <param name="menu" value="false" />
                            <param name="quality" value="high" />
                            <embed src="images/tit_extravio.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="548" height="111"></embed>
                          </object>
                          </noscript></td>
                      </tr>
                      <tr>
                        <td><table width="93%" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td width="548" class="negro">
                              <div align="left"> En caso de robo o p&eacute;rdida, vos o tu adicional deber&aacute;n comunicarlo inmediatamente&nbsp; a <strong class="celeste">Carta Autom&aacute;tica</strong>, al <strong class="celeste">0810-999-9988 </strong> o al n&uacute;mero que figura al dorso de tu tarjeta, o sino dirigirse personalmente a nuestra sucursal m&aacute;s cercana. <br>
</div></td>
                          </tr>
                          <tr>
                            <td class="negro">&nbsp;</td>
                          ...
                          <tr>
                            <td class="negro"><span class="celeste"><strong>Carta Autom&aacute;tica</strong></span> se har&aacute; responsable por las compras o transacciones que se hicieren con la tarjeta robada o extraviada, s&oacute;lo desde las 00:00 hs. del d&iacute;a que se realiza la denuncia. </td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
