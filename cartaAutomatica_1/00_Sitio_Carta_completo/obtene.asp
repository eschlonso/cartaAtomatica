...
//  if (txtDNI == "")
//    {msg +="DNI\n"};
  var txtMedio = document.frmObtene.txtMedio.value;
  if (txtMedio == "")
    {msg +="¿Cómo te enteraste de Carta Automática?\n"};
...
'		on error resume next
		...
		if Not objMail.EOF then
			...
			strBody = "Se ha recibido una solicitud de tarjeta con los siguientes datos: <br>Nombre: " &strNombre & "<br>Apellido: " & strApellido &_
					 "<br>Localidad: " & strLocalidad & "<br>Provincia: " & strProvincia & "<br>Teléfono: " &strTelefono & "<br>Móvil: " & strMovil & "<br>Horario de contacto: " & strHorario & "<br>DNI: " & strDNI & "<br>email: " & strMail & "<br>Cómo se enteró de Carta Automática?: " & strMedio
                  ...
                  <tr>
                    ...
                    <td><table border="0" cellspacing="0" cellpadding="0">
                     ...
                     <%if strMensaje="" then %>
                            ...
                            <tr>
                            	<td><img src="images/solicitala-ya.jpg" alt="" /></td>
                            </tr>   
                             <tr>
                            	<td>&nbsp;</td>
                            </tr>
                      <tr>
                        <td><table width="530" border="0" align="center" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td width="548"><table width="500"  border="0" cellpadding="0" cellspacing="0">
                              ...
                              <!--  <tr>
                                ...
                                <tr>
                                  <td colspan="3"><table width="500" border="0" align="center" cellpadding="3" cellspacing="1">
                                    <tr bgcolor="#B9EAF7">
                                      <td height="30" bgcolor="#EAF9FD"><div align="right" class="negro"><strong>Nombre *</strong></div></td>
                                    ...
                                    <tr bgcolor="#DDF4FB">
                                     ...
                                     <tr bgcolor="#DDF4FB">
                                      <td height="30" bgcolor="#EAF9FD" class="negro"> <div align="right"><strong>¿Cómo te <br/>enteraste de<br/> Carta Automática? *</strong> </div></td>
                                      <td bgcolor="#C5F0FA"><div align="center">
                                        <input name="txtMedio" id="txtMedio" type="text" class="selector heightcomment" id="" size="40">
                                      </div></td>
                                    </tr>
                                    <tr bgcolor="#FFFFFF">
                      ...
                      <%else%>
                      <tr>
                        <td align="center" class="negro"><% = strMensaje %></td>
                      </tr>
                     <%end if %>
                      <tr>
                        <td height="30">&nbsp;</td>
