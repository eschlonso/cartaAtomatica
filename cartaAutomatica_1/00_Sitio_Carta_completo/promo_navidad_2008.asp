                ...
                <td><table width="550" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="548"><table width="548" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td>
                          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="548" height="111">
                            <param name="movie" value="images/tit_navidad_2008.swf">
                            <param name="quality" value="high">
                            <param name="wmode" value="opaque">
                            <embed src="images/tit_navidad_2008.swf" quality="high" wmode="opaque" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="548" height="111"></embed>
                          </object></td>
                      </tr>
                      <tr>
                        <td align="center" valign="top"><img src="images/juga_gana_navidad.jpg" width="325" height="967"></td>
                      </tr>
                      <tr>
