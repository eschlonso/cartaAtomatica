                ...
                <td><table width="550" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="548"><table width="548" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><script type="text/javascript">AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0','width','548','height','111','src','images/tit_planes','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','images/tit_planes','menu','false' ); //end AC code</script>
                          <noscript>
                          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"   codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="548" height="111">
                            <param name="movie" value="images/tit_planes.swf" />
                            <param name="menu" value="false" />
                            <param name="quality" value="high" />
                            <embed src="images/tit_planes.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="548" height="111"></embed>
                          </object>
                          </noscript></td>
                      </tr>
                      <tr>
                        <td align="center"><table width="93%" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td class="titulos"><div align="left"><strong><em> Eleg&iacute; c&oacute;mo abonar tus compras </em></strong></div></td>
                          </tr>
                          <tr>
                            <td class="negro"> <div align="left">Contamos con una variedad de planes de cuotas sin inter&eacute;s o con m&iacute;nimos intereses de financiaci&oacute;n. </div></td>
                          </tr>
                          <tr>
                            <td class="negro">&nbsp;</td>
                          </tr>
                          <tr>
                            <td class="negro"><div align="center"><img src="images/planes.gif" width="427" height="414"></div></td>
                          </tr>
                          <tr>
                            <td width="548" class="negro"><p align="left">&nbsp;</p></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
