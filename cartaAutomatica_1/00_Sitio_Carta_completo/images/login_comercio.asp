...
.negro table tr td table tr .negro table tr td div .negro {
	color: #6AA224;
}
-->
</style>
...
<body onload=";document.getElementById('cuit').style.display = 'block';document.getElementById('socio').style.display = 'none';document.getElementById('tipoyNro').style.display = 'none'; document.getElementById('comercio').style.display = 'block'">
  <!-- Google Tag Manager -->
                      ...
                      <form name="frmLoguin" method="post" action="CartaTran/validacion.asp">
                        ...
                        <tr>
                          ...
                          <td width="548"><table width="548" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td height="120"><img src="images/tit_consultacomercios.jpg" width="548" height="110"></td>
                            </tr>
                            <tr>
                              <td><table width="93%" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                  <td class="negro"><table width="430" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#6aa224">
                                    <tr>
                                      <td><table width="430" border="0" align="center" cellpadding="3" cellspacing="0">
                                        <!-- AAG 20120225 I -->
                                        <!-- <tr bgcolor="#B9EAF7">
																			<td height="30" bgcolor="#EAF9FD">
																			<div align="right" class="negro">
																				<strong>Seleccion&aacute; si sos socio o comercio<br>
																				</strong>
																			</div>
																			<div align="center">
																			</div>
                                        ...
                                        <input name="strLoginType" type="hidden" value="2">
                                        <!-- AAG 20120225 F -->
                                        <tr bgcolor="#EAFDED">
                                          <td height="30" bgcolor="#EAFDED" class="negro"><div id="tipoyNro" align="right"> <strong>N&uacute;mero de CUIT</strong></div>
                                            <div id="cuit" align="right" style="display: none;"> <strong>N&uacute;mero de C.U.I.T.</strong></div></td>
                                          <td bgcolor="#EAFDED"><div align="center">
                                            <div id="socio" style="display: block;">
                                              <input name="strDocumento" type="text" class="selector" size="28" maxlength="11" />
                                            </div>
                                        ...
                                        <tr bgcolor="#EAFDED">
                                          <td height="30" bgcolor="#EAFDED" class="negro"><div align="right"> <strong>Contrase&ntilde;a</strong></div></td>
                                          <td bgcolor="#EAFDED"><div align="center">
                                            <div align="center">
                                        ...
                                        <tr bgcolor="#EAFDED">
                                          <td bgcolor="#EAFDED" class="negro"><div align="right"></div>
                                            <div align="right"></div>
                                            <div align="right"></div>
                                            <div align="right"></div></td>
                                          <td bgcolor="#EAFDED"><div align="center"></div>
                                        ...
                                        <tr bgcolor="#FFFFFF">
                                          ...
                                          <td rowspan="2" bgcolor="#FFFFFF"><div align="right">
                                            <input type="image" target="_blank" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image11','','images/ingresar_b.gif',1)" href="javascript:document.frmLoguin.submit();" src="images/ingresarx.jpg" name="Ingresar" width="111" height="31" border="0">
                                          </div></td>
                                        </tr>
                                        <tr bgcolor="#FFFFFF">
