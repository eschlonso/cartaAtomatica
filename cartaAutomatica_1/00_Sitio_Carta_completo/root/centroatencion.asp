                    ...
                    <td valign="top"><table width="549" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td width="547" valign="top"><table width="547" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td align="center"><img src="images/tit_centrocomercios.jpg" width="548" height="110"></td>
                          </tr>
                          <tr>
                            <td width="547" align="center"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td align="left" class="txt_negro"><p class="negroch"><span class="lal"><span class="lal">Te informamos nuestro Centro de Atenci&oacute;n al Comercio disponible las 24horas,<br>
                                  con el que podr&aacute; ganar tiempo en todas sus operaciones y consultas.</span></span></p>
                                  <p class="negroch"><span class="lal"><span class="lal">                                    El Centro de atenci&oacute;n al Comercio de Carta Automatica le permite:<br>
                                    <br>
                                    &bull; Solicitar Autorizaciones de compras de Carta Autom&aacute;tica.<br>
                                    &bull; Conocer el disponible de compra de la tarjeta con la que esta operando.<br>
                                    &bull; Anular una operaci&oacute;n.<br>
                                    &bull; Consultar sobre temas administrativos o correspondientes a su liquidaci&oacute;n de<br>
                                    Carta Automatica.</span></span></p>
                                  <p class="gris3">&nbsp;</p></td>
                              </tr>
                              <tr>
                                <td height="1" align="center" bgcolor="#CCCCCC" class="txt_negro"></td>
                              </tr>
                              <tr>
                                <td height="40" align="center" class="tit_1"><strong>Centro de atenci&oacute;n al Comercio</strong><br>
                                  <strong>0810-222-8888</strong></td>
                              </tr>
                              <tr>
                                <td height="1" align="center" bgcolor="#CCCCCC" class="txt_negro"></td>
                              </tr>
                              <tr>
                                <td align="center" class="txt_negro">&nbsp;</td>
                              </tr>
                              <tr>
                                <td align="center" class="txt_negro"><p class="negro">Si  todav&iacute;a no tienen su clave de identificaci&oacute;n, solic&iacute;tela llamando<br>
al  0810-999-9988.</p></td>
                              </tr>
                            </table>
                              <br></td>
                          </tr>
