                ...
                <td><table width="550" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="548"><table width="548" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><script type="text/javascript">AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0','width','548','height','111','src','images/tit_recarga_celular','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','images/tit_recarga_celular','menu','false' ); //end AC code</script>
                          <noscript>
                          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"   codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="548" height="111">
                            <param name="movie" value="images/tit_recarga_celular.swf" />
                            <param name="menu" value="false" />
                            <param name="quality" value="high" />
                            <embed src="images/tit_recarga_celular.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="548" height="111"></embed>
                          </object>
                          </noscript></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td height="19" align="center"><img src="images/promo_recarga_tu_celular02_10.jpg" width="521" height="295"><br></td>
                      </tr>
                      <tr>
                        <td height="20" align="center" valign="bottom"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="left" class="gris2"><p><br>
                              Promoci&oacute;n v&aacute;lida desde el 01/02/10 hasta el 28/02/10 o hasta agotar stock de 320 unidades. Participan todos los socios de Carta Autom&aacute;tica que realicen recargas de celulares. La carga de  celulares se efect&uacute;a a trav&eacute;s del servicio prestado por Movilcarga  S.A.  Cuit: 30-70883915-5, domicilio: Av. Corrientes 569, Piso 2, Ciudad Aut&oacute;noma de Buenos Aires, Argentina. N&uacute;meros de atenci&oacute;n al cliente de Movistar: *611 o  0800-321-0611,  Claro:  * 611 o 0800-123-0611,  Personal: * 111 o 0800-444-0800</p>
                              <p></p></td>
                          </tr>
                        </table></td>
                      </tr>
