                    ...
                    <td width="548"><table width="548" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="548" height="111">
                          <param name="movie" value="images/tit_adelantos_efectivo.swf">
                          <param name="quality" value="high">
                          <embed src="images/tit_adelantos_efectivo.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="548" height="111"></embed>
                        </object></td>
                      </tr>
                      <tr>
                        <td align="center"><table width="93%" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td align="center"><img src="images/promo_0907_adelantos_efecti.jpg" width="338" height="480"><br>
                              <br>
                              <table width="93%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td align="left" class="titulos"><em><strong>Obten&eacute; adelantos en efectivo en el momento que lo necesites.</strong></em></td>
                                </tr>
                                <tr>
                                  <td align="left" class="negro">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td width="548" align="left" class="negro"><p align="left"> Dirigite a nuestra sucursal m&aacute;s cercana con tu <strong class="celeste">Carta Autom&aacute;tica </strong> y <strong class="celeste">DNI </strong> y obten&eacute; un anticipo en efectivo. <br>
                                  </p></td>
                                </tr>
                                <tr>
                                  <td align="left" class="negro">&nbsp;</td>
                                ...
                                <tr>
                                  <td align="left" class="negro">En una operatoria &aacute;gil y segura, obten&eacute;s un pr&eacute;stamo en efectivo y lo pag&aacute;s <span class="celeste"><strong>hasta en 12 cuotas</strong></span> iguales y en pesos, debitadas en tu resumen de cuenta de tu tarjeta Carta Autom&aacute;tica. </td>
                                </tr>
                              </table></td>
                          </tr>
                          ...
                          <tr>
                            <td align="left" class="gris2">Promoci&oacute;n v&aacute;lida para clientes titulares y/o adicionales. Para retirar un adelanto en  efectivo la cuenta debe tener l&iacute;mite y no encontrarse en mora.<br>
                              Vigencia: adelantos solicitados desde el 01/09/07 al 30/09/07.<br>
                              Fecha de sorteo: 01/10/07.</td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
