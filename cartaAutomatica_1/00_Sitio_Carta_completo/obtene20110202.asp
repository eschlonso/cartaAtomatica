...
'		on error resume next
		...
		if Not objMail.EOF then
			...
			strBody = "Se ha recibido una solicitud de tarjeta con los siguientes datos: <br>Nombre: " &strNombre & "<br>Apellido: " & strApellido &_
					 "<br>Localidad: " & strLocalidad & "<br>Provincia: " & strProvincia & "<br>Teléfono: " &strTelefono & "<br>Móvil: " & strMovil & "<br>Horario de contacto: " & strHorario & "<br>DNI: " & strDNI & "<br>email: " & strMail
