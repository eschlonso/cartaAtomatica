...
<html>
	<head>
		<title>Usuario no válido</title>
		<SCRIPT LANGUAGE="JavaScript">
			setTimeout("top.location.href = '../Loguin.asp'",2000);
          ...
          <tr>
			...
			<table width="433" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td class="subtitulos" bgcolor="#CAE8FB">
                    <p align="center"><font face="Verdana">Los datos ingresados 
                    no pertenecen a un usuario válido, o bien, el tiempo de 
                    espera ha caducado.</font></td>
