                ...
                <table width="555" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td valign="top"><table width="549" border="0" cellspacing="0" cellpadding="0">
                    	<form name="frmPedila" method="post" action="CartaTran/agregarsolicitudPrestamo.asp">
                                    ...
                                    <td colspan="2" bgcolor="#ececec"><div align="center">
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          ...
                                          <td width="37%" class="negroch"><input name="txtSexo" type="radio" value="masculinoA" checked />Masculino</td>
