...
// ########## LIQUIDACIONES PREVIAS (DEL MES)
	...
	if(objDB.query(strQuery)) {
		while(rsLiquidacion = objDB.each()) {
			...
			/*arrParams["liqPrevImage_old"]   = "<A href=\"#\" onClick=\"JavaScript: window.open('popup_comercios_liquidacion_detalle.asp?LiquidacionId=" + rsLiquidacion.LiquidacionId + "', 'liquidacion', 'scrollbars=yes,width=600,height=400');\"><IMG class=\"image\" src=\"images/ic_verinfo.gif\" width=\"67\" height=\"12\"/></A>"*/
			arrParams["liqPrevImage"]   = "<A href=\"#\" onClick=\"JavaScript: window.open('pagina_construccion.asp', 'construccion', 'scrollbars=yes,width=600,height=400');\"><IMG class=\"image\" src=\"images/ic_verinfo.gif\" width=\"67\" height=\"12\"/></A>"
