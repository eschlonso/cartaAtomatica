...
<UL id="menu_socios" style="position: relative;">
	...
	<LI style="background-color: #CAE2F2;"><IMG src="images/bullet_menu_exclusivo.gif" width="5" height="7" vspace="2" hspace="4" border="0"/><A href="default.asp?strSection=comercios&strContentType=pagina_construccion" class="itemMenuExclusivo">construccion</A></LI>
