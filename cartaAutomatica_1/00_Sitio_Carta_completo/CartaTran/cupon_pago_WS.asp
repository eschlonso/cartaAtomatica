...
strSoap =	"<?xml version='1.0' encoding='utf-8'?>"& _
			...
			"<soap:Body>"& _
			"<generarCuponPago xmlns='http://tempuri.org/'>"& _
			"<cuenta>"&Session("UserID")&"</cuenta>"& _
			"<carpetaDestino>"&Server.MapPath("Resumenes")&"</carpetaDestino>"& _
			"</generarCuponPago>"& _
			"</soap:Body>"& _
			"</soap:Envelope>"
strSOAPAction = "http://tempuri.org/generarCuponPago"
...
If InvokeWebService (strSoap, strSOAPAction, strURL, xmlResponse) Then
    ...
    urlPDF = xmlResponse.documentElement.selectSingleNode("soap:Body/generarCuponPagoResponse/generarCuponPagoResult").text
	archivo = urlPDF
