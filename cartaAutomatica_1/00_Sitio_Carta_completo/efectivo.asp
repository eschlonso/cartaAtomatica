                ...
                <td><table width="550" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="548"><table width="548" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><script type="text/javascript">AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0','width','548','height','111','src','images/tit_efectivo','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','images/tit_efectivo','menu','false' ); //end AC code</script>
                          <noscript>
                          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"   codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="548" height="111">
                            <param name="movie" value="images/tit_efectivo.swf" />
                            <param name="menu" value="false" />
                            <param name="quality" value="high" />
                            <embed src="images/tit_efectivo.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="548" height="111"></embed>
                          </object>
                          </noscript></td>
                      </tr>
                      <tr>
                        <td><table width="93%" border="0" align="center" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td class="titulos"><strong>Las respuesta inmediata para lo  que no puede esperar.</strong></td>
                          </tr>
                          <tr>
                            <td class="negro">&nbsp;</td>
                          </tr>
                          <tr>
                            <td class="negro"><SPAN lang="es">A</SPAN><SPAN lang="es"></SPAN><SPAN lang="es">delantos en   efectivos en el acto, para aquello que no puede esperar.</SPAN></td>
                          </tr>
                          <tr>
                            <td class="negro">&nbsp;</td>
                          </tr>
                          <tr>
                            <td class="negro"><SPAN lang="es">Solicitalo presentando tu tarjeta   Titular o Adicional, DNI, y devolvelo hasta en 4 cuotas, en&nbsp; cualquier sucursal   de Carta Automatica del pa&iacute;s.</SPAN></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
