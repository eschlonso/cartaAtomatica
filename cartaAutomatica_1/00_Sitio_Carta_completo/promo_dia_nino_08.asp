                ...
                <td><table width="550" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="548"><table width="548" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><script type="text/javascript">AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0','width','548','height','111','src','images/tit_promo_dia_nino_08','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','images/tit_promo_dia_nino_08','menu','false' ); //end AC code</script>
                          <noscript>
                          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"   codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="548" height="111">
                            <param name="movie" value="images/tit_promo_dia_nino_08.swf" />
                            <param name="menu" value="false" />
                            <param name="quality" value="high" />
                            <embed src="images/tit_promo_dia_nino_08.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="548" height="111"></embed>
                          </object>
                          </noscript></td>
                      </tr>
                      <tr>
                        <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="center" class="negro" ><img src="images/promo_dia_nino_08.jpg" width="438" height="637"></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td height="19" align="center"><table width="98%" cellspacing="0" cellpadding="0">
                          <tr>
                            <td align="left" class="negroch"><span class="celeste">Legales</span><br>
                              (1) Promoci&oacute;n v&aacute;lida entre el 1/8/2008 y el 31/8/2008 para clientes de Carta Autom&aacute;tica que realicen compras en las Jugueter&iacute;as adheridas a la tarjeta en esa fecha. Consultar listado de jugueter&iacute;as en la Sucursal de Carta Autom&aacute;tica. (2) Para clientes que realicen una compra superior a $200 en las jugueter&iacute;as adheridas y se presenten en la Sucursal de Carta Autom&aacute;tica con el cup&oacute;n de la tarjeta. Premios hasta agotar stock de 50 unidades.</td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
