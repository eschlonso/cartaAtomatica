                ...
                <td><table width="550" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="548"><table width="548" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><script type="text/javascript">AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0','width','548','height','111','src','images/tit_promo_efectivo_extra','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','images/tit_promo_efectivo_extra','menu','false' ); //end AC code</script>
                          <noscript>
                          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"   codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="548" height="111">
                            <param name="movie" value="images/tit_promo_efectivo_extra.swf" />
                            <param name="menu" value="false" />
                            <param name="quality" value="high" />
                            <embed src="images/tit_promo_efectivo_extra.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="548" height="111"></embed>
                          </object>
                          </noscript></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td height="19" align="center"><img src="images/img_efectivo_extra.jpg" width="490" height="492"></td>
                      </tr>
                      <tr>
                        <td height="50" align="center" valign="bottom"><table width="98%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td align="left" class="negroch"><strong>Legales:</strong> <br>
                              Sujeto a aprobaci&oacute;n crediticia. V&aacute;lido para titulares de la tarjeta de cr&eacute;dito Carta Autom&aacute;tica presentando el DNI y el &uacute;ltimo recibo de sueldo. Consultar requisitos para aut&oacute;nomos en las Sucursales de Carta Autom&aacute;tica. Direcciones en www.cartaautomatica.com.ar. TNA 82% TEM 6,86%. <br></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
