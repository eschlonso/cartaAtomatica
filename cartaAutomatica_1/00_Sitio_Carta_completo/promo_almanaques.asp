                ...
                <td><table width="550" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="548"><table width="548" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><script type="text/javascript">AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0','width','548','height','111','src','images/tit_almanaques','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','images/tit_almanaques','menu','false' ); //end AC code</script>
                          <noscript>
                          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"   codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="548" height="111">
                            ...
                            <param name="menu" value="false" />
                            <param name="quality" value="high" />
                            <embed src="images/tit_almanaques.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="548" height="111"></embed>
                          </object>
                          </noscript></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td height="19" align="center"><img src="images/almanaque.jpg" alt="almanaque" /><br></td>
                      </tr>
                      <tr>
                        <td height="20" align="center" valign="bottom"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td colspan="3" align="left" class="gris2">&nbsp;</td>
                          </tr>
                          <tr>
                            <td colspan="3" align="left" class="gris2">&nbsp;</td>
                          </tr>
                          ...
                          <tr>
                            <td colspan="3" align="left" class="gris2"><p>&nbsp;</p>
                              <p></p></td>
                          </tr>
                        </table></td>
                      </tr>
