...
function alerta()
{
  ...
  if (msg){
       ...
       window.alert(msg1);
		...
		//document.getElementById("hidOperacion").value = 1
		document.frmRRHH.submit();
   }
}
//-->
</script>
...
<body onLoad="MM_preloadImages('images/enviar_b.gif')">
													...
													<table width="555" border="0" cellspacing="0" cellpadding="0">
													    ...
													    <%
															if (Request.QueryString("estado") <> "") then
																fileUploaded = Request.QueryString("estado")
																if not (fileUploaded <> "True") Then
																	...
																	objMessage.Subject = "Envio de CV" 
																	objMessage.From = "cvrrhh@cartaautomatica.com.ar"
																	objMessage.To = "cvrrhh@cartaautomatica.com.ar"
																	'objMessage.To = "martin.schwartzman@cordialfinanciera.com.ar"
																	objMessage.TextBody = Request.Form("file")
																	objMessage.AddAttachment "\\tahq002vw0178.tarjeta.local\CartaAutomatica\cvs\" + Request.QueryString("file")
																	objMessage.Send
																	strMensaje = "CV Enviado."
																	intOperacion = 0
																else
																	strMensaje = "No se pudo cargar el CV."
																end if
															end if
																	...
																	<tr>
																		...
																		<td width="547" valign="top">
																			<table width="547" border="0" cellspacing="0" cellpadding="0">
																				...
																				<tr>
																					<td align="center"><img src="images/tit_rrhh.jpg" alt="" width="548" height="70"></td>
																				</tr>
																				<tr>
																					<td height="20" align="center" class="textover"><p style="text-align:center; font-size:16px;">Envianos tu CV y te tendremos en cuenta <br />en las próximas búsquedas!</p>&nbsp;</p></td>
																				</tr>
																				<tr>
																					<td height="20">
																						<div align="center" class="titulos">
																							<table width="450" border="1" cellpadding="0" cellspacing="0" bordercolor="#6f6f6e">
																								<tr>
																									<td>
																										<FORM METHOD="POST" name="frmRRHH" ACTION="insert.asp" enctype="multipart/form-data">
																											<table width="450" border="0" align="center" cellpadding="3" cellspacing="1">
																													
																												<%if strMensaje="" then %>
																												<tr bgcolor="#ececec">
																													<td width="316" height="30">
																														<div align="center">
																															<input type="file" name="file" id="file" size="30">
																															<input type="hidden" name="hidOperacion" id="hidOperacion" value="1" >
																														</div>
																													</td>
																													<td width="119" bgcolor="#ececec">
																														<div align="right"><a href="javascript:alerta();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image17','','images/enviar2_b.jpg',1)"><img src="images/enviar2_a.jpg" alt="" name="Image17" width="95" height="30" border="0"></a></div>
																													</td>
																												</tr>
																												<%else%>
																												<tr>
