                ...
                <td><table width="550" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="548"><table width="548" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><script type="text/javascript">AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0','width','548','height','111','src','images/tit_cuotas','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','images/tit_cuotas','menu','false' ); //end AC code</script>
                          <noscript>
                          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"   codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="548" height="111">
                            <param name="movie" value="images/tit_cuotas.swf" />
                            <param name="menu" value="false" />
                            <param name="quality" value="high" />
                            <embed src="images/tit_cuotas.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="548" height="111"></embed>
                          </object>
                          </noscript></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td height="19" align="center"><img src="images/promo_cuotas_sin_interes.jpg" width="521" height="490"><br></td>
                      </tr>
                      <tr>
                        <td height="20" align="center" valign="bottom"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="left" class="gris2"><p>                              Promoci&oacute;n v&aacute;lida desde el 01/01/10 hasta el 31/01/10. TNA 0,00%, TEA 0,00% y SEGURO DE VIDA 0,45%. CFT (CFT): 5,54%. (1) V&aacute;lido s&oacute;lo en sucursal La Plata. (2) V&aacute;lido s&oacute;lo en sucursal La Plata y Bah&iacute;a Blanca.</p>
                              <p></p></td>
                          </tr>
                        </table></td>
                      </tr>
