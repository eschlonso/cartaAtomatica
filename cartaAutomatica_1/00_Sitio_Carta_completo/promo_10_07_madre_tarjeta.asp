...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <td width="548"><table width="548" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="548" height="111">
                          <param name="movie" value="images/promo_mes_mama/tit_mama_tarjeta.swf">
                          <param name="quality" value="high">
                          <embed src="images/promo_mes_mama/tit_mama_tarjeta.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="548" height="111"></embed>
                        </object></td>
                      </tr>
                      <tr>
                        <td align="center"><table width="93%" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td align="center"><img src="images/promo_mes_mama/promo_mama_tarjeta.jpg" width="347" height="538"><br>
                              <br>
                              <table width="93%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td align="left" class="titulos"><em><strong>Tarjetas Adicionales</strong></em></td>
                                </tr>
                                <tr>
                                  <td align="left" class="negro">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td width="548" align="left" class="negro"><p align="left">Con una tarjeta adicional,
                                    elegir el regalo ideal
                                    ya no es una tarea dif&iacute;cil,
                                    porque lo elige ella.</p></td>
                                </tr>
                                <tr>
                                  <td align="left" class="negro">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td align="left" class="negro"><li>Totalmente gratuita.                                  
                                    <li> Pod&eacute;s determinar un l&iacute;mite de compra mensual.                                    
                                    <li> Con los mismos beneficios que la tarjeta titular.                                    
                                    <li> Recib&iacute; un &uacute;nico resumen mensual con                                    
                                    <li> el detalle de los consumos de cada tarjeta.</td>
                                </tr>
                              </table></td>
                          </tr>
  ...
  <tr>
    ...
    <td height="9"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="4%" height="10"><span class="estilo"><a href="http://www.quick-media.com" target="_blank" class="blanco">FP</a></span></td>
