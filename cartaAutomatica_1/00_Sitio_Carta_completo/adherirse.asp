...
function alerta()
{
  ...
  if (txtNombrecomercio == "")
    {msg +="Nombre fantasía del comercio\n"};
...
'		on error resume next
		...
		if Not objMail.EOF then
			...
			'objMessage.Send()
			objMessage.Subject = "Adhesión de comercio" 
			objMessage.From = "Web_CartaAutomatica@CartaAutomatica.com.ar"
			objMessage.To = "comercialwebcarta@CartaAutomatica.com.ar"
			strBody = "Se ha recibido una solicitud de adhesión de comercio con los siguientes datos: <br>Nombre: " &strNombre & "<br>Apellido: " & strApellido & "<br>Razón Social: " &strRazonSocial & "<br>Nombre Fantasía: "& strNombrecomercio & "<br>CUIT: " & strCUIT &_
					 "<br>Dirección: " & strDireccion & "<br>Localidad: " & strLocalidad & "<br>Teléfono: " &strTelefono & "<br>Comentarios: " & strComentarios & "<br>mail: " & strMail
			objMessage.HTMLBody = strBody
			objMessage.Send
